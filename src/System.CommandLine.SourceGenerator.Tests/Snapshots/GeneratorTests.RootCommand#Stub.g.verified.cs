...
namespace System.CommandLine.SourceGenerator.Tests
{
    public static class StubFactory
    {
        public static global::System.CommandLine.RootCommand Create()
        {
            ...
            {
                Handler = new StubCommandHandler(symbol, symbol1, symbol2, symbol3, symbol4, symbol5)
            };
            ...
            cmd.AddCommand(global::System.CommandLine.SourceGenerator.Tests.StubSubFactory.Create());
            return cmd;
        }

        private sealed class StubCommandHandler : global::System.CommandLine.Invocation.ICommandHandler
        {
            ...
            {
                var command = new global::System.CommandLine.SourceGenerator.Tests.Stub()
                {
                ...
                var handler = new global::System.CommandLine.SourceGenerator.Tests.StubHandler();
